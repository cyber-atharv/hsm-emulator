...
pub const manufacturer_id = "cyber-atharv";
pub const library_description = "Zig HSM Emulator";
pub const slot_description = "cyber-atharv HSM Emulator Slot 0";
pub const token_label = "cyber-atharv-HSM";
...
pub const token_path_env = "cyber-atharv_HSM_TOKEN";
pub const token_path_default = ".cyber-atharv-hsm-token";
...
pub const object_path_env = "cyber-atharv_HSM_OBJECTS";
pub const object_path_default = ".cyber-atharv-hsm-objects";
