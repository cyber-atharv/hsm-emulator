...
const smoke_token = "/tmp/cyber-atharv-hsm-smoke-token.bin";
const smoke_objects = "/tmp/cyber-atharv-hsm-smoke-objects.bin";

extern "c" fn setenv(name: [*:0]const u8, value: [*:0]const u8, overwrite: c_int) c_int;

pub fn main() !void {
    _ = setenv("cyber-atharv_HSM_TOKEN", smoke_token, 1);
    _ = setenv("cyber-atharv_HSM_OBJECTS", smoke_objects, 1);
